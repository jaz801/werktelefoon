...
export function ContentScrollLink() {
  ...
  return (
    <button
      ...
      className="content-scroll-link relative inline cursor-pointer border-0 bg-transparent p-0 font-[family-name:var(--font-indivisible)] font-semibold text-inherit"
